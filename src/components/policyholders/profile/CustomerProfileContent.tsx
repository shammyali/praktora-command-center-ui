...
import { Search, FileText, Mail, MessageSquare, RefreshCw, AlertTriangle, Eye, 
  Plus, CreditCard, FileUp, MoreHorizontal } from "lucide-react";
import { 
  DropdownMenu, 
  DropdownMenuContent, 
  DropdownMenuItem, 
...
const CustomerProfileContent = ({ customer }: CustomerProfileContentProps) => {
  ...
  // Sample data for tabs - using the same data from PortfolioTracker
  const policiesData = [
    {
      id: 1,
  ...
  return (
    <>
      ...
      {/* Section 2: Client Portfolio Summary - NEW SECTION */}
      {portfolioSummary ? (
      ...
      {/* Section 3: Tabbed Content - REPLACING Portfolio Tracker */}
      <Card className="mt-6">
