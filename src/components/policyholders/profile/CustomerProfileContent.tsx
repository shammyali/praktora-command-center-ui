    ...
    <>
      ...
      <Tabs defaultValue="policies" className="mb-6">
        <TabsList className="grid grid-cols-4 mb-4">
          ...
          <TabsTrigger value="financial">Financial Actions</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="enquiries">
          <div className="p-6 text-center text-muted-foreground">
            Enquiry history for {customer.fullName}
          </div>
        </TabsContent>
        
        <TabsContent value="claims">
          <div className="p-6 text-center text-muted-foreground">
            Claims history for {customer.fullName}
          </div>
        </TabsContent>
        
        <TabsContent value="financial">
          <div className="p-6 text-center text-muted-foreground">
            Financial actions for {customer.fullName}
          </div>
        </TabsContent>
      </Tabs>
