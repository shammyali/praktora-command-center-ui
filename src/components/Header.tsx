      ...
      <div className="flex h-16 items-center justify-between px-4 sm:px-6">
        <div className="flex items-center">
          ...
          <img 
            ...
            className="h-10 md:h-12 transition-all duration-500 hover:scale-110 animate-pulse-slow hover:animate-none" 
          />
        </div>
        
        {/* Command Panel in the center */}
        <div className="absolute left-1/2 transform -translate-x-1/2 flex flex-col items-center">
          <h1 className="text-lg font-semibold text-praktora-burgundy">P²RA: Intelligence in Motion</h1>
